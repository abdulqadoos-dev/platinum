export default function About() {
  ...
  const boxes = [
    {
      title: "HEALTH & SAFETY",
      description: "Platinum Track Prioritizes Safety, Reliability & Efficiency, Ensuring Quality Work Meets Deadlines And Client Expectations.",

      icon: SafetyIcon,
    },
    {
      title: "PROFESSIONAL ETHICS",
      description: "Trust Is The Foundation Of Any Strong Relationship. At Platinum Track, We Work Daily To Cultivate That Trust Through Our Actions.",

      icon: EthicsIcon,
    },
    {
      title: "EXPERIENCE & QUALITY",
      description: "Platinum Track Rail Services Has A Management Team With Over 40 Years Of Experience And Spanning Three Generations.",
      icon: ExperienceIcon,
    },
    {
